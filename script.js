...
function renderAdaptiveRevisionCard(){
  ...
  if(!items.length)return '<div class="card ww-adaptive-card"><div class="ww-adaptive-head"><div><div class="card-title">🧠 Révision adaptative</div><div class="ww-adaptive-sub">Aucune priorité forte détectée pour le moment.</div></div><span class="ww-adaptive-badge">63.6.3</span></div><button class="btn-outline" data-stats-tab="adaptive" style="width:100%;justify-content:center;margin-top:10px;">Voir le moteur</button></div>';
...
window.WWAppCore={state:state,render:render,navigate:navigate,version:'63.6.3',events:window.WWEventBus,renderer:window.WWRenderer};
