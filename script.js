...
async function saveState(){
  ...
  saveStateQueue=saveStateQueue.then(async function(){if(window.WWAcademicOSCutover&&window.__WW_ACADEMIC_OS_PRIMARY){await window.WWAcademicOSCutover.persist(state)}return dbSet('appState',snapshot)}).catch(function(e){console.warn('saveState error',e)});
