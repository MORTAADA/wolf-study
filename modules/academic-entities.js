...
(function(global){
  ...
  var TYPES={subject:'subject',topic:'topic',session:'session',task:'task',resource:'resource',exam:'exam',error:'error',flashcard:'flashcard',planning:'planning',mastery:'mastery'};
  var defaults={
  ...
  function normalize(type,input){
    ...
    if(type==='session'){out.plannedMinutes=Number(out.plannedMinutes||0);out.actualMinutes=Number(out.actualMinutes||0)}
    return out;
  }
