...
(function(global){
  ...
  function scoreTopic(state,topic){if(!topicActive(state,topic))return null;var p=topicProgress(state,topic.id),e=topicEvidence(state,topic.id),errors=unresolvedErrors(state,topic),score=0,reasons=[];
