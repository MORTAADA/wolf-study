...
(function(global){
  ...
  function scoreTopic(state,topic){var p=topicProgress(state,topic.id),e=topicEvidence(state,topic.id),errors=unresolvedErrors(state,topic),score=0,reasons=[];
  ...
  global.WWAdaptiveRevision={version:'63.2',build:build,summary:summary,scoreTopic:scoreTopic,errorItems:errorItems};
})(window);
